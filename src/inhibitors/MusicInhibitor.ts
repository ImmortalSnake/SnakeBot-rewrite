...
export default class extends Inhibitor {
    ...
    public run(msg: KlasaMessage, command: Command | MusicCommand) {
        ...
        if (command.music.includes('VOICE_PLAYING') && !audio?.playing) throw `I am not playing anything!`;
        ...
        if (command.music.includes('SNAKE_VC') && !msg.guild.me?.voice.channelID) throw `I am not in any voice channel! Make me join one`;
